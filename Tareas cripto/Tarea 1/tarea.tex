  ...
  \section{Punto 2)}
    ...
    \subsection{Cifrado de Vigenère}
      ...
      \begin{itemize}
        ...
        \item Paso 3) Una vez tenemos la palabra $t := \sigma_{j_1}\cdots\sigma_{j_{k}}$, donde $2k = p$,
              para conocer la clave debemos hacer una sustitución hacia atrás, para ello,
              vemos que la primera letra corresponde a $\sigma_{l_1}$, donde $l_1$ corresponde
              al único natural que cumple que $1 + l_1 = j_1$. Procediendo de esta forma, la letra número $m$ de 
              la clave corresponde a $\sigma_{l_m}$, donde $l_m$ es el único entero tal que $1+l_m = j_m$.
              Aplicando $k$ veces esto, conocemos la clave.
      \end{itemize}
      
      Se concluye que si la clave tiene longitud $k$, se usan $2k$ palabras.
  \section{Punto 3)}
